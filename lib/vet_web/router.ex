defmodule VetWeb.Router do
  ...
  if Application.compile_env(:vet, :dev_routes) do
  ...
  scope "/", VetWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{VetWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", VetWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{VetWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", VetWeb do
    ...
    live_session :current_user,
      on_mount: [{VetWeb.UserAuth, :mount_current_user}] do
